...
import com.qa.ims.controller.CostsController;
...
public class IMS {
	...
	private final CostsController costs;
	...
	public IMS() {
		...
		final CostsDAO costsDAO = new CostsDAO();
		...
		this.costs = new CostsController(costsDAO, utils);
	}
